...
of gravity $(\bar x)$ are given below (\fig \ref{fig:neturalAxis}).
...
\ref{fig:SectoinUnderBendingandAxialLoad}, by the various strain
...
\label{fig:SectoinUnderBendingandAxialLoad}
\end{figure}
%=========================End figure ============================%
...
the point A (\fig \ref{fig:SectoinUnderBendingandAxialLoad}).
On a similar analogy, the line rotating about the
point B (\fig \ref{fig:SectoinUnderBendingandAxialLoad}) gives different
...
various types of steel given in \tablem 1.2. \fig
\ref{fig:SectoinUnderBendingandAxialLoad} gives by similar triangles,
...
\eqn \ref{TypesofSteel} and are given in \tablem 1.2 for ready reference.
...
also shown in \fig \ref{fig:SectoinUnderBendingandAxialLoad}.
