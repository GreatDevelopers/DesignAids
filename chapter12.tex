...
similar to those given by the ACI ~\citetitle{IS2000} . The design of footings in
...
\begin{equation}
        ...
        \sage{tau_a}=\sage{z}
\end{equation}
$\sage{tau_c}$ is given by \tablemacro 19 of the Code depending on the steel area provided for moment at the critical section 2-2 (the minimum value of $\sage{tau_c}$ is assumed for $p_t $$\leq$$ 0.15$ in \tablemacro 19.
...
\item  \textbf{Design for beam shear}
 ...
 \equmacro (\ref{eq:ultimatemoment22c}) gives,
  ...
  \tablemacro 19 gives ${tau_c}$ = 0.035 \text{$kN/cm^2$}
